...
const Product = ({product}) => {
  ...
  return (
    <div>
      ...
      {/* button */}
      <div className='absolute top-6 right-11 p-2 group-hover:right-5 flex flex-col justify-center items-center 
        ...
        <Link to={`/product/${id}`}  className='w-12 h-12 flex justify-center items-center bg-white
